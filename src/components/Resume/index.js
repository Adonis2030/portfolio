...
export default function Resume() {
  return (
    <div id="resume" className="min-h-screen flex-col text-center">
      <div className="text-5xl font-bold py-8 mt-10" data-aos={"slide-down"}>
        Resume
      </div>
      <div className="grid grid-cols-2 gap-7 mt-7">
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          <div className="text-3xl font-bold py-3">My Main Skills</div>
          <div className="ml-16 flex flex-col gap-8 mt-6">
            <BarGraph name={"HTML/CSS"} percent={98} />
            <BarGraph name={"JavaScript"} percent={95} />
            <BarGraph name={"React"} percent={90} />
            <BarGraph name={"TypeScript"} percent={90} />
            <BarGraph name={"Angular"} percent={85} />
            <BarGraph name={"Vue"} percent={80} />
            <BarGraph name={"React Native"} percent={75} />
            <BarGraph name={"Flutter"} percent={75} />
            <BarGraph name={"NodeJS"} percent={75} />
            <BarGraph name={"PHP"} percent={90} />
            <BarGraph name={"Laravel"} percent={80} />
            <BarGraph name={"Python"} percent={70} />
            <BarGraph name={"Django"} percent={70} />
          </div>

          <a
            href={require("../../assets/files/Maksym_Shyhapov.pdf")}
            download={"Maksym_Shyhapov"}
